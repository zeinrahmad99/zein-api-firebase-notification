...
namespace Evexel\FirebaseNotification\Http\Controllers;

use Illuminate\Http\Request;
use Illuminate\Validation\Rule;
use Illuminate\Support\Facades\Auth;
use Illuminate\Routing\Controller;
use Evexel\FirebaseNotification\Models\FCMToken;
use Evexel\FirebaseNotification\Models\Notification;
use Evexel\FirebaseNotification\Http\Resources\NotificationResource;
